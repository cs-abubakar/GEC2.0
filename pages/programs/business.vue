<template>
  <div class="program-page">
      ...
      <div class="container mx-auto px-4">
        <div class="max-w-4xl mx-auto text-center">
          <div class="inline-block bg-white/10 backdrop-blur-sm px-6 py-2 rounded-full mb-6">
            <span class="text-white font-semibold">Business & Economics</span>
          </div>
          <h1 class="text-4xl md:text-6xl font-bold mb-6 font-display text-gray-900">
            Business & International Trade in China
          </h1>
          <p class="text-xl md:text-2xl mb-8 text-gray-800">
            Study business in the world's second-largest economy and global trade powerhouse
          </p>
          <div class="flex flex-wrap gap-4 justify-center mb-8">
            <div class="bg-white/20 backdrop-blur-sm px-6 py-3 rounded-lg">
              <div class="text-2xl font-bold text-gray-900">4 Years</div>
              <div class="text-sm text-gray-800">Bachelor Degree</div>
            </div>
            <div class="bg-white/20 backdrop-blur-sm px-6 py-3 rounded-lg">
              <div class="text-2xl font-bold text-gray-900">English</div>
              <div class="text-sm text-gray-800">Medium of Teaching</div>
            </div>
            <div class="bg-white/20 backdrop-blur-sm px-6 py-3 rounded-lg">
              <div class="text-2xl font-bold text-gray-900">Global</div>
              <div class="text-sm text-gray-800">Career Focus</div>
            </div>
          </div>
          <div class="flex flex-wrap gap-4 justify-center">
            <NuxtLink to="/contact" class="btn-primary bg-primary-blue text-white hover:bg-blue-700 px-8 py-4 rounded-lg font-semibold text-lg transition-all">
              Get Started Now
            </NuxtLink>
            <a href="https://wa.me/8618672301888" class="btn-secondary bg-white/10 backdrop-blur-sm text-gray-900 hover:bg-white/20 px-8 py-4 rounded-lg font-semibold text-lg transition-all">
              WhatsApp Us
            </a>
          </div>
        </div>
    ...
    <!-- Why Choose Business in China -->
    <section class="py-20 bg-white">
      <div class="container mx-auto px-4">
        <div class="text-center mb-16">
          <h2 class="text-3xl md:text-5xl font-bold mb-4 font-display">Why Study Business in China?</h2>
          <p class="text-xl text-gray-600 max-w-3xl mx-auto">
            Position yourself at the center of global commerce and international trade
          </p>
        </div>
    ...
    <section class="py-20 bg-gray-50">
      <div class="container mx-auto px-4">
        <div class="text-center mb-16">
          <h2 class="text-3xl md:text-5xl font-bold mb-4 font-display">Business Program Options</h2>
          <p class="text-xl text-gray-600 max-w-3xl mx-auto">
            Multiple specializations to match your career aspirations
          </p>
        </div>
    ...
    <section class="py-20 bg-white">
      <div class="container mx-auto px-4">
        <div class="text-center mb-16">
          <h2 class="text-3xl md:text-5xl font-bold mb-4 font-display">Top Business Universities</h2>
          <p class="text-xl text-gray-600 max-w-3xl mx-auto">
            Study at prestigious institutions offering world-class business education
          </p>
        </div>
            ...
            <div class="p-6">
              <div class="space-y-4">
                ...
                <div>
                  ...
                  <div class="font-semibold">Top 50 business schools globally</div>
                </div>
                <div>
                  <div class="flex items-center text-sm text-gray-500 mb-1">
                  ...
                  <ul class="space-y-1 text-gray-700">
                    <li>• AACSB and EQUIS accredited</li>
                    <li>• Located in China's financial center</li>
            ...
            <div class="p-6">
              <div class="space-y-4">
                ...
                <div>
                  ...
                  <div class="font-semibold">#1 for International Trade in China</div>
                </div>
                <div>
                  <div class="flex items-center text-sm text-gray-500 mb-1">
                    <span class="mr-2">✨</span> Highlights
                  ...
                  <ul class="space-y-1 text-gray-700">
                    <li>• Specializes in international trade</li>
                    <li>• Large international student community</li>
                    <li>• Government and ministry connections</li>
                    <li>• Excellent job placement rate</li>
                  </ul>
                </div>
              </div>
            </div>
            ...
            <div class="p-6">
              <div class="space-y-4">
                ...
                <div>
                  ...
                  <div class="font-semibold">Top finance & economics university</div>
                </div>
                <div>
                  <div class="flex items-center text-sm text-gray-500 mb-1">
                    <span class="mr-2">✨</span> Highlights
                  ...
                  <ul class="space-y-1 text-gray-700">
                    <li>• Excellence in finance and economics</li>
                    <li>• Strong banking industry connections</li>
                    <li>• CFA and ACCA program partnerships</li>
            ...
            <div class="p-6">
              <div class="space-y-4">
                ...
                <div>
                  ...
                  <div class="font-semibold">Top 100 business schools globally</div>
                </div>
                <div>
                  <div class="flex items-center text-sm text-gray-500 mb-1">
                    <span class="mr-2">✨</span> Highlights
                  ...
                  <ul class="space-y-1 text-gray-700">
                    <li>• Premier social sciences university</li>
                    <li>• Strong economics programs</li>
                    <li>• Located near government district</li>
    ...
    <section class="py-20 bg-gray-50">
      <div class="container mx-auto px-4">
        <div class="text-center mb-16">
          ...
          <p class="text-xl text-gray-600 max-w-3xl mx-auto">
            Diverse career paths in international business and trade
          </p>
        </div>
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
          <div class="bg-white p-6 rounded-xl text-center hover:shadow-lg transition-all">
            ...
            <h3 class="font-bold text-lg mb-2">Import/Export Manager</h3>
            <p class="text-gray-600 text-sm">International trade operations</p>
          </div>

          <div class="bg-white p-6 rounded-xl text-center hover:shadow-lg transition-all">
            <div class="text-3xl mb-3">💼</div>
            <h3 class="font-bold text-lg mb-2">Business Consultant</h3>
            <p class="text-gray-600 text-sm">China-focused advisory</p>
          </div>

          <div class="bg-white p-6 rounded-xl text-center hover:shadow-lg transition-all">
            <div class="text-3xl mb-3">📊</div>
            <h3 class="font-bold text-lg mb-2">Financial Analyst</h3>
            <p class="text-gray-600 text-sm">Investment and markets</p>
          </div>

          <div class="bg-white p-6 rounded-xl text-center hover:shadow-lg transition-all">
            <div class="text-3xl mb-3">🚢</div>
            <h3 class="font-bold text-lg mb-2">Supply Chain Manager</h3>
            <p class="text-gray-600 text-sm">Global logistics</p>
          </div>

          <div class="bg-white p-6 rounded-xl text-center hover:shadow-lg transition-all">
            <div class="text-3xl mb-3">📈</div>
            <h3 class="font-bold text-lg mb-2">Marketing Director</h3>
            <p class="text-gray-600 text-sm">International brands</p>
          </div>

          <div class="bg-white p-6 rounded-xl text-center hover:shadow-lg transition-all">
            <div class="text-3xl mb-3">🏢</div>
            <h3 class="font-bold text-lg mb-2">Business Development</h3>
            <p class="text-gray-600 text-sm">Market expansion</p>
          </div>

          <div class="bg-white p-6 rounded-xl text-center hover:shadow-lg transition-all">
            <div class="text-3xl mb-3">🛒</div>
            <h3 class="font-bold text-lg mb-2">E-Commerce Manager</h3>
            <p class="text-gray-600 text-sm">Online business</p>
          </div>

          <div class="bg-white p-6 rounded-xl text-center hover:shadow-lg transition-all">
            <div class="text-3xl mb-3">🚀</div>
            <h3 class="font-bold text-lg mb-2">Entrepreneur</h3>
            <p class="text-gray-600 text-sm">Own business venture</p>
          </div>
        </div>
      </div>
    </section>
...
// SEO
useHead({
  title: 'Business & International Trade in China - Study Business Abroad | GEC Pathways',
  meta: [
    { name: 'description', content: 'Study Business Administration & International Economy and Trade in China. Learn from the world\'s second-largest economy. Top universities, English medium programs. Expert guidance from GEC.' },
    { name: 'keywords', content: 'business china, international trade, study business abroad, mba china, business administration, economics china, study trade' }
  ]
})
</script>
