<template>
  <div class="program-page">
      ...
      <div class="container mx-auto px-4">
        <div class="max-w-4xl mx-auto text-center">
          <div class="inline-block bg-white/10 backdrop-blur-sm px-6 py-2 rounded-full mb-6">
            <span class="text-accent-yellow font-semibold">Language & Culture</span>
          </div>
          <h1 class="text-4xl md:text-6xl font-bold mb-6 font-display">
            Chinese Language Programs in China
          </h1>
          <p class="text-xl md:text-2xl mb-8 text-gray-200">
            Master Mandarin Chinese in its native environment. From beginner to advanced levels.
          </p>
          <div class="flex flex-wrap gap-4 justify-center mb-8">
            <div class="bg-white/10 backdrop-blur-sm px-6 py-3 rounded-lg">
              <div class="text-2xl font-bold text-accent-yellow">Flexible</div>
              <div class="text-sm">Program Duration</div>
            </div>
            <div class="bg-white/10 backdrop-blur-sm px-6 py-3 rounded-lg">
              <div class="text-2xl font-bold text-accent-yellow">All Levels</div>
              <div class="text-sm">Beginner to Advanced</div>
            </div>
            <div class="bg-white/10 backdrop-blur-sm px-6 py-3 rounded-lg">
              <div class="text-2xl font-bold text-accent-yellow">HSK</div>
              <div class="text-sm">Certificate Preparation</div>
            </div>
          </div>
    ...
    <section class="py-20 bg-white">
      <div class="container mx-auto px-4">
        <div class="text-center mb-16">
          <h2 class="text-3xl md:text-5xl font-bold mb-4 font-display">Why Learn Chinese in China?</h2>
          <p class="text-xl text-gray-600 max-w-3xl mx-auto">
            Mandarin Chinese is the most spoken language globally - essential for international careers
          </p>
        </div>
    ...
    <section class="py-20 bg-gray-50">
      <div class="container mx-auto px-4">
        <div class="text-center mb-16">
          <h2 class="text-3xl md:text-5xl font-bold mb-4 font-display">Program Options</h2>
          <p class="text-xl text-gray-600 max-w-3xl mx-auto">
            Flexible programs designed for different goals and schedules
          </p>
        </div>
    ...
    <section class="py-20 bg-white">
      <div class="container mx-auto px-4">
        <div class="text-center mb-16">
          <h2 class="text-3xl md:text-5xl font-bold mb-4 font-display">HSK Proficiency Levels</h2>
          <p class="text-xl text-gray-600 max-w-3xl mx-auto">
            Understand the Chinese language proficiency framework
          </p>
        </div>
        ...
        <div class="max-w-5xl mx-auto space-y-4">
          <div class="bg-gray-50 p-6 rounded-xl">
            <div class="flex items-start">
              <div class="w-20 h-20 bg-gradient-to-br from-green-400 to-green-600 text-white rounded-lg flex items-center justify-center font-bold text-2xl mr-6 flex-shrink-0">
                HSK 1
              </div>
              <div class="flex-1">
                ...
                <div class="text-sm text-gray-500">Duration: 2-3 months of intensive study</div>
              </div>
            </div>
          </div>
          ...
          <div class="bg-gray-50 p-6 rounded-xl">
            <div class="flex items-start">
              <div class="w-20 h-20 bg-gradient-to-br from-green-500 to-green-700 text-white rounded-lg flex items-center justify-center font-bold text-2xl mr-6 flex-shrink-0">
                HSK 2
              </div>
              <div class="flex-1">
                ...
                <div class="text-sm text-gray-500">Duration: 3-4 months of intensive study</div>
              </div>
            </div>
          </div>
          ...
          <div class="bg-gray-50 p-6 rounded-xl">
            <div class="flex items-start">
              <div class="w-20 h-20 bg-gradient-to-br from-yellow-400 to-yellow-600 text-white rounded-lg flex items-center justify-center font-bold text-2xl mr-6 flex-shrink-0">
                HSK 3
              </div>
              <div class="flex-1">
                ...
                <div class="text-sm text-gray-500">Duration: 4-6 months of intensive study</div>
              </div>
            </div>
          </div>
          ...
          <div class="bg-gray-50 p-6 rounded-xl">
            <div class="flex items-start">
              <div class="w-20 h-20 bg-gradient-to-br from-orange-400 to-orange-600 text-white rounded-lg flex items-center justify-center font-bold text-2xl mr-6 flex-shrink-0">
                HSK 4
              </div>
              <div class="flex-1">
                ...
                <div class="text-sm text-gray-500">Duration: 6-8 months of intensive study | Required for most degree programs</div>
              </div>
            </div>
          </div>
          ...
          <div class="bg-gray-50 p-6 rounded-xl">
            <div class="flex items-start">
              <div class="w-20 h-20 bg-gradient-to-br from-red-400 to-red-600 text-white rounded-lg flex items-center justify-center font-bold text-2xl mr-6 flex-shrink-0">
                HSK 5
              </div>
              <div class="flex-1">
                ...
                <div class="text-sm text-gray-500">Duration: 1-1.5 years of intensive study</div>
              </div>
            </div>
          </div>
          ...
          <div class="bg-gray-50 p-6 rounded-xl">
            <div class="flex items-start">
              <div class="w-20 h-20 bg-gradient-to-br from-purple-500 to-purple-700 text-white rounded-lg flex items-center justify-center font-bold text-2xl mr-6 flex-shrink-0">
                HSK 6
              </div>
              <div class="flex-1">
                ...
                <div class="text-sm text-gray-500">Duration: 2+ years of intensive study | Professional fluency</div>
              </div>
            </div>
          </div>
        </div>
    ...
    <section class="py-20 bg-gray-50">
      <div class="container mx-auto px-4">
        <div class="text-center mb-16">
          <h2 class="text-3xl md:text-5xl font-bold mb-4 font-display">Top Language Universities</h2>
          <p class="text-xl text-gray-600 max-w-3xl mx-auto">
            Study at prestigious institutions specializing in Chinese language education
          </p>
        </div>
              ...
              <div class="space-y-4">
                ...
                <div>
                  ...
                  <ul class="space-y-1 text-gray-700">
                    <li>• China's top Chinese language university</li>
                    <li>• 9,000+ international students from 140+ countries</li>
                    <li>• All levels from beginner to advanced</li>
                    <li>• Excellent HSK pass rates</li>
                  </ul>
                </div>
              </div>
            </div>
            ...
            <div class="p-6">
              <div class="space-y-4">
                ...
                <div>
                  ...
                  <ul class="space-y-1 text-gray-700">
                    <li>• Top comprehensive university</li>
                    <li>• Modern international metropolis setting</li>
                    <li>• Quality language programs</li>
            ...
            <div class="p-6">
              <div class="space-y-4">
                ...
                <div>
                  ...
                  <ul class="space-y-1 text-gray-700">
                    <li>• China's #1 university</li>
                    <li>• Beautiful historic campus</li>
                    <li>• Prestigious language programs</li>
                    <li>• Pathway to degree programs</li>
                  </ul>
                </div>
              </div>
            </div>
            ...
            <div class="p-6">
              <div class="space-y-4">
                <div>
                  ...
                  <div class="font-semibold">Nanjing, Jiangsu</div>
                </div>
                <div>
                  <div class="flex items-center text-sm text-gray-500 mb-1">
                    <span class="mr-2">✨</span> Highlights
                  ...
                  <ul class="space-y-1 text-gray-700">
                    <li>• Historic city with modern amenities</li>
                    <li>• Affordable living costs</li>
                    <li>• Quality teaching standards</li>
    ...
    <section class="py-20 bg-white">
      <div class="container mx-auto px-4">
        <div class="text-center mb-16">
          ...
          <p class="text-xl text-gray-600 max-w-3xl mx-auto">
            Chinese language proficiency opens diverse career paths
          </p>
        </div>
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
          <div class="bg-gray-50 p-6 rounded-xl text-center hover:shadow-lg transition-all">
            ...
            <h3 class="font-bold text-lg mb-2">Chinese Language Teacher</h3>
            <p class="text-gray-600 text-sm">Teach globally or online</p>
          </div>

          <div class="bg-gray-50 p-6 rounded-xl text-center hover:shadow-lg transition-all">
            <div class="text-3xl mb-3">🌍</div>
            <h3 class="font-bold text-lg mb-2">Translator/Interpreter</h3>
            <p class="text-gray-600 text-sm">Professional translation services</p>
          </div>

          <div class="bg-gray-50 p-6 rounded-xl text-center hover:shadow-lg transition-all">
            <div class="text-3xl mb-3">💼</div>
            <h3 class="font-bold text-lg mb-2">International Business</h3>
            <p class="text-gray-600 text-sm">China-related business roles</p>
          </div>

          <div class="bg-gray-50 p-6 rounded-xl text-center hover:shadow-lg transition-all">
            <div class="text-3xl mb-3">🏛️</div>
            <h3 class="font-bold text-lg mb-2">Diplomat/Foreign Service</h3>
            <p class="text-gray-600 text-sm">Government and embassy work</p>
          </div>

          <div class="bg-gray-50 p-6 rounded-xl text-center hover:shadow-lg transition-all">
            <div class="text-3xl mb-3">✈️</div>
            <h3 class="font-bold text-lg mb-2">Tourism & Hospitality</h3>
            <p class="text-gray-600 text-sm">Travel industry specialist</p>
          </div>

          <div class="bg-gray-50 p-6 rounded-xl text-center hover:shadow-lg transition-all">
            <div class="text-3xl mb-3">📰</div>
            <h3 class="font-bold text-lg mb-2">Journalism & Media</h3>
            <p class="text-gray-600 text-sm">International correspondent</p>
          </div>

          <div class="bg-gray-50 p-6 rounded-xl text-center hover:shadow-lg transition-all">
            <div class="text-3xl mb-3">🎬</div>
            <h3 class="font-bold text-lg mb-2">Entertainment Industry</h3>
            <p class="text-gray-600 text-sm">Film, TV, content creation</p>
          </div>

          <div class="bg-gray-50 p-6 rounded-xl text-center hover:shadow-lg transition-all">
            <div class="text-3xl mb-3">🔬</div>
            <h3 class="font-bold text-lg mb-2">Academic Research</h3>
            <p class="text-gray-600 text-sm">Sinology and China studies</p>
          </div>
        </div>
      </div>
    </section>
    ...
    <section class="py-20 bg-gradient-to-br from-primary-blue via-accent-purple/70 to-primary-green text-white">
      <div class="container mx-auto px-4 text-center">
        ...
        <p class="text-xl mb-8 max-w-2xl mx-auto">
          Learn Mandarin Chinese in the best environment possible. Expert guidance from GEC's team of 50+ professionals with 95% visa success rate.
        </p>
        <div class="flex flex-wrap gap-4 justify-center">
...
// SEO
useHead({
  title: 'Chinese Language Programs in China - HSK Preparation | Study Mandarin | GEC',
  meta: [
    { name: 'description', content: 'Learn Chinese Language in China. Short-term and long-term programs, HSK preparation, Bachelor degrees. Study Mandarin in immersive environment. Expert guidance from GEC.' },
    { name: 'keywords', content: 'learn chinese, mandarin china, hsk preparation, chinese language program, study chinese, language courses china, mandarin classes' }
  ]
})
</script>
