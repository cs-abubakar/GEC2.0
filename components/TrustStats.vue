    ...
    <div class="container-custom">
      <div class="grid grid-cols-2 md:grid-cols-4 gap-8">
        ...
        <div class="stat-card">
          ...
          <div class="stat-number" ref="stat1">500+</div>
        ...
        <div class="stat-card">
          ...
          <div class="stat-number text-accent-yellow" ref="stat3">95%</div>
        ...
        <div class="stat-card">
          ...
          <div class="stat-number" ref="stat4">15+</div>
...
onMounted(() => {
  ...
  if (stat1.value && stat1.value.parentElement && stat1.value.parentElement.parentElement) {
