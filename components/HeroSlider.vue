<template>
  <section class="hero-slider relative h-[600px] md:h-[700px] overflow-hidden">
    <!-- Slides -->
      ...
      >
        ...
        <div class="container-custom relative z-20 h-full flex items-center">
          <div class="max-w-3xl text-white">
            <div class="inline-block bg-accent px-4 py-2 rounded-full mb-6 animate-fade-in-down">
